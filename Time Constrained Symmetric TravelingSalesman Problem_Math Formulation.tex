...
\begin{document}
\section*{Time Constrained Symmetric Traveling\\ Salesman Problem (ATSPTW)}
\subsection*{Sets}
...
\end{equation}
\begin{equation}
	t_i-t_{j}\geq t_{ij}- M_{ij}\cdot y_{ij}  \qquad \forall i,j=0,1,...,n
	\tag{4}
\end{equation}
\begin{equation}
	t_j-t_{i}\geq t_{ij}- (1-y_{ij})\cdot M_{ij} \qquad \forall i,j=0,1,...,n
	\tag{5}
\end{equation}
\begin{equation}
